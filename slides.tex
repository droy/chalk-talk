...
\documentclass[reqno,oneside,twocolumn,8pt]{amsart}
...
\usepackage[
	paperwidth=128mm, %% these are Beamer's default dimensions.   
	paperheight=96mm, %% some newer projectors are more widescreen
